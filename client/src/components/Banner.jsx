...
const Banner = () => {
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 md:pl-14 pt-10 bg-gradient-to-r
...
<p className='max-w-130'>We take care of insurance, driver verifiction and secure payments - so you can earn passive income, stress-free</p>
