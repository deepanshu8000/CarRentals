  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14
      ...
      <h1 className='text-4xl md:text-5xl font-semibold'>
        Luxurious Wheels On Rent
      </h1>

      <form onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-cent
      ...
      bg:white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
            ...
            <div className='flex flex-col items-start gap-2'>
             ...
             <div className='flex flex-col items-start gap-2'>
                ...
                <input value={pickupDate} onChange={e=>setPickupDate(e.target.value)} type="date" id="pickup-date" min={new Date().toISOString().
                  split('T')[0]} className='text-sm text grey-500' required/>
             </div>
             <div className='flex flex-col items-start gap-2'>
                <label htmlFor='Retutn-date'>Return Date</label>
        ...
        <button className='flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-primary hover:bg-primary-dull
