    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          <img src={car.image} alt="car image" className='w-full h-auto md:max-h-100 object-cover rounded-x1 mb-6 shadow-md' />
        ...
        <form className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <button onSubmit={handleSubmit} className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white 
