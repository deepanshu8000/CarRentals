           ...
           gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12 '>
            ...
            <div className='md:col-span-2'>
              ...
              <div className='flex items-start gap-2'>
                <img src={assets.calendar_icon_colored} alt="calendar_icon" className='w-4 h-4 mt-1' />
                <div>
               ...
               <div className='flex items-start gap-2'>
                <img src={assets.location_icon_colored} alt="calendar_icon" className='w-4 h-4 mt-1' />
                <div>
