  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Bookings"
        subTitle="Track all customer's bookings, approve or cancel request, and manage bookings status" />
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          ...
          <tbody>
            {bookings.map((booking, index) => (
              <tr key={index} className='border-t border border-borderColor text-gray-500'>
                <td className='p-3 flex item-centre gap-3'>
